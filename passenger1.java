	...
	public class passenger1 {
		...
		public static void main(String[] args) 
		{
			...
			JLabel L1=new JLabel("p_name:");
			L1.setBounds(50, 70, 100, 50);
		    JLabel L2=new JLabel("p_age:");
		    L2.setBounds(50, 110, 100, 50);
		    JLabel L3=new JLabel("p_genger:");
			L3.setBounds(50, 160, 100, 50);
		    JLabel L4=new JLabel("p_phno:");
				 ...
				 public void actionPerformed(ActionEvent e)
			        {
							...
							try {
							     ...
							     String k=T4.getText();
							     String m=T5.getText();
								String query="INSERT INTO passenger1 VALUES(?,?,?,?,?)";
							    ...
							    passenger1 Data=new passenger1();
